...
| ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| B0 [#10](https://github.com/GhostFlying/cove/issues/10) detailed plan        | `/root/m0_b0_plan`, GPT-6 Astra high; `cove-worktrees/m0-package-plan`, branch `p/luchengxuan/m0-10-package-plan`; only `docs/tasks/m0-package-plan.md` | Pin needed stable candidates and minimal useful probe/build boundaries; no code/config/install mutations in planning |
| B0 integration and coordination                                              | Coordinator; primary checkout `p/luchengxuan/m0-10-package-integration`; handoff/execution records                                                      | Assign a single manifest/lockfile/config writer after plan; separate testing/review                                  |
...
Current allocation is coordinator plus one planner and two worktrees; recompute live allocation before dispatch. Limits remain five task agents/worktrees globally and four native agents including coordinator. No recursive dispatch. No application or remote workload has yet been executed in M0.
...
Next: finish B0 concrete planning, dispatch its implementation with exclusive manifest/lockfile ownership, independently test/review and integrate; then release P1a. Continue inside approved M0, escalating only actual product/architecture/scope/acceptance decisions. X1 completion never authorizes M1 automatically.
